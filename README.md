...
Como resultado final, si su marco teórico es correcto, la app da cuenta del nivel de temperatura en el discurso de cada dominio utilizado --o "encontrado", algo que puede ser parecido a lo que tradicionalmente se denominan "tópicos", o "asuntos", o lo que los medios tradicionales llaman "secciones": deportes, sociedad, política...).
