...
Como resultado final, si su marco teórico es correcto, la app da cuenta del nivel de temperatura en el discurso. Lo hace visualizando un ranking de temperatura de "dominios", algo que puede ser parecido a un ranking de lo que tradicionalmente se denominan "tópicos", o "asuntos"--(lo que los medios tradicionales llaman "secciones": deportes, sociedad, política...).
