...
El proyecto se inscribe en el marco de las humanidades digitales (2.0) ya que, basada en datos en tiempo real, los discursos se analizan desde un modelo <em>Bayesiano</em> ligado a la ligüística. 
